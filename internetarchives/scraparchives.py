    ...
    for row in table.find_all('tr')[1:]:
        ...
        if len(cols) >= 2:
            ...
            if link_tag and link_tag.get('href'):
                ...
                if file_name.lower().endswith('.zip') or file_name.lower().endswith('.st') or file_name.lower().endswith('.bin'):
...
# URL da página
base_url = 'https://archive.org/download/AtariSTRomsetByGhostware2018'
file = 'atarist.csv'
scrap(file, base_url)